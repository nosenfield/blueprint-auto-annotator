...
> **⚠️ DEPRECATED:** This document has been superseded by [task-list-v2.md](./task-list-v2.md).  
> **Please use task-list-v2.md for the current task list.**  
...
**Acceptance Criteria:**
- [x] Directory structure matches architecture-v2.md
